...
#define STRING_CONFIG_H_AUTHOR "(Tinoyster, default config)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Tronxy x5"
 ...
 */
#define MICROSTEPS 1 // (1=1/16, 2=1/32)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { MICROSTEPS*80, MICROSTEPS*80, MICROSTEPS*400, MICROSTEPS*90 } //
